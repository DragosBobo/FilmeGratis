                ...
                <div class="regFormContainer">
                    ...
                    <div class="stepHeader-body">
                        <div class="group">
                            ...
                            <input type="text" id="fname" name="firstname" autocomplete="off" require>
                        </div>
                        <div class="group">
                            <label for="lname">Last Name</label>
                            <input type="text" id="lname" name="lastname" autocomplete="off" require>
                        </div>
                        <div class="group">
                            <label for="email">Email</label>
                            <input type="text" id="email" name="email" autocomplete="off" require>
                        </div>
                        <div class="group">
                            <label for="pwd">Password</label>
                            <input type="text" id="pwd" name="pwd" autocomplete="off" require>
                        </div>
